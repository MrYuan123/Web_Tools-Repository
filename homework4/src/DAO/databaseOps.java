...
public class databaseOps {
    ...
    public List<movieBean> SearchOps(String type, String keyword){
        List<movieBean> returnlist = new ArrayList<movieBean>();
...
//        returnlist.add(title);
        try{
            ...
            while(rs.next()){
                movieBean nowBean = new movieBean();
                nowBean.setTitle(rs.getString("title"));
                nowBean.setActor(rs.getString("actor"));
                nowBean.setActress(rs.getString("actress"));
                nowBean.setGenre(rs.getString("genre"));
                nowBean.setYear(rs.getInt("year"));
                returnlist.add(nowBean);
            }
        }catch (Exception e){
